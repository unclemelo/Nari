...
class Moderation(commands.Cog):
    ...
    async def respond_and_delete(self, interaction: discord.Interaction, embed: discord.Embed):
    ...
    async def mute_cmd(self, interaction: discord.Interaction, member: discord.Member, minutes: int, reason: str = "No reason provided"):
        ...
        try:
            ...
            await self.respond_and_delete(interaction, self.build_embed(f"🤐 {member.display_name} muted!", f"Duration: {minutes} minutes", discord.Color.blue()))
    ...
    async def warn_cmd(self, interaction: discord.Interaction, member: discord.Member, reason: str = "No reason provided"):
        ...
        await self.respond_and_delete(interaction, self.build_embed(f"⚠️ Warned {member.display_name}", f"Reason: {reason}", discord.Color.yellow()))
    ...
    async def kick_cmd(self, interaction: discord.Interaction, member: discord.Member, reason: str = "No reason provided"):
        ...
        try:
            ...
            await self.respond_and_delete(interaction, self.build_embed(f"🥾 {member.display_name} kicked!", f"Reason: {reason}", discord.Color.orange()))
    ...
    async def ban_cmd(self, interaction: discord.Interaction, member: discord.Member, reason: str = "No reason provided"):
        ...
        try:
            ...
            await self.respond_and_delete(interaction, self.build_embed(f"🔨 {member.display_name} banned!", f"Reason: {reason}", discord.Color.red()))
    ...
    async def unban_cmd(self, interaction: discord.Interaction, user_id: int):
        try:
            ...
            await self.respond_and_delete(interaction, self.build_embed(f"✨ {user.name} unbanned!", "Let's hope they behave this time.", discord.Color.green()))
